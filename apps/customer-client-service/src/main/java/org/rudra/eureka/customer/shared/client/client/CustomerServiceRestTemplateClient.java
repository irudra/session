package org.rudra.eureka.customer.shared.client.client;

import org.rudra.eureka.customer.shared.Customer;
import org.rudra.eureka.customer.shared.client.controller.MessageWrapper;
...
public class CustomerServiceRestTemplateClient {
    ...
    public MessageWrapper<Customer> getCustomer(int id) {
        ...
        Customer customer = restTemplate.exchange(
                "http://customer-service/app/customer/{id}",
                HttpMethod.GET,
                null,
